...
<table cellpadding="3" cellspacing="0" border="1">
    <tr>
        <td colspan="8">
            ...
            <tr><td class="left">
            <form method="get" action="test14_update.php">
    ...
    <?php
        while ($a = mysqli_fetch_row($res)) {
            ...
            echo '<td>'.$a[5].'</td>';
            echo '<td>'.'<a href="test14_update_set.php?numb='.$a[0].'&items='.$items.'&page='.$page.'">수정</a>'.'</td>';
            echo '</tr>';
        }
    ?>
    <tr>
        ...
        <?php
            for ($i=1; $i <= $pageCount; $i++) {
                ...
                if ($i == $page) {
                    ...
                    echo '[<a href="test14_update.php?items='.$items.'&page='.$i.'">'.$i.'</a>]';
                }
                echo '</span>';
            }
        ?>
