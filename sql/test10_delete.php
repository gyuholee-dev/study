...
<table cellpadding="3" cellspacing="0" border="1">
    <tr>
        <td colspan="6" style="padding: 8px;">
            <table class="inner" width="100%" border="0">
                <form method="get" action="test10_delete.php">
                    <tr><td class="left">
                    항목수
    ...
    <?php
        while ($a = mysqli_fetch_row($res)) {
            ...
            echo '<td>'.$a[6].'</td>';
            // echo '<td>'.'삭제'.'</td>';
            echo '<td><a href="test10_delete_del.php?code='.$a[0].'&items='.$items.'&page='.$page.'">삭제</td>';
            echo '</tr>';
        }
    ?>
    <tr>
        ...
        <?php
            ...
            while ($i < $pageCount+1) {
                ...
                if ($i == $page) {
                    ...
                    echo '[<a href="test10_delete.php?items='.$items.'&page='.$i.'">'.$i.'</a>]';
                }
                echo '</span>';
                $i++;
            }
