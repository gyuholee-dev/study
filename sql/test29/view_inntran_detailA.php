...
$whereSql = "WHERE trandate='$trandate' ";
  ...
  <table cellpadding="3" cellspacing="0">
    ...
    <?php
      ...
      while ($a = mysqli_fetch_assoc($res)) {
        ...
        echo '<td class="left">'.$a['item_name'].'</td>';
        echo '<td class="left">'.$a['item_spec'].'</td>';
  ...
  <div class="tbMenu">
    <?php
      ...
      if ($cpage == 1) {
        ...
        echo '<a href="view_inntran_detailA.php?'.
             '?cpage='.'1'.'&trandate='.$trandate.
             '&page='.$page.'&year='.$year.'&month='.$month.'"><<</a>';
      }
      echo '</span>';
      ...
      if ($rows > 0) {
        ...
        for ($i=1; $i<=$pageCount; $i++) {
          ...
          if ($i == $cpage) {
            ...
            echo '[<a href="view_inntran_detailA.php'.
                 '?cpage='.$i.'&trandate='.$trandate.
                 '&page='.$page.'&year='.$year.'&month='.$month.'">'.$i.'</a>]';
          }
          echo '</span>';
        }
      } else {
      ...
      if ($cpage == $pageCount) {
        ...
        echo '<a href="view_inntran_detailA.php'.
             '?cpage='.$pageCount.'&trandate='.$trandate.
             '&page='.$page.'&year='.$year.'&month='.$month.'">>></a>';
      }
      echo '</span>';
