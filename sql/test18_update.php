...
<div class="tbContents">
    <div class="tbMenu">
        ...
        <tr><td class="left">
        <form method="get" action="test18_update.php">
            ...
            onclick="location.href='test18_update.php'">
        </td></tr>
        </table>
    </div>
    ...
    <?php
        while ($a = mysqli_fetch_assoc($res)) {
            ...
            echo '<td>'.$a['phon'].'</td>';
            echo '<td>'.$bord.'</td>';
            echo '<td><a href="test18_update_set.php?numb='.$a['numb'].
                 '&items='.$items.'&page='.$page.
                 '&sort='.$sort.'&order='.$order.'">수정</td>';
            echo '</tr>';
        }
    ?>
    </table>
    ...
    <?php
        for ($i=1; $i<=$pages; $i++) { 
            ...
            if ($i == $page) {
                ...
                echo '[<a href="test18_update.php?items='.$items.'&page='.$i.
